...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`
      ${styles.padding} absolute inset-0
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center">
          <h1 className={`${styles.heroHeadText} font-extrabold  text-white`}>
              Food<span 
                className={`${styles.heroHeadText} font-extrabold text-transparent 
                bg-clip-text bg-gradient-to-r
              from-purple-600 via-pink-600 to-blue-600`}>
                  Ful</span>
           {/* <span className="text-[#e5ec2c]">
            Sanyam
            </span> */}
          </h1>
